...
export const Header = () => {
  ...
  return (
    ...
    >
        ...
        max-auto mt-10 text-center'>Turn text to <br/> 
        ...
        >Unleash your creativity with AI. Turn your
            ...
            <motion.button onClick={onClickHanler} className='sm:text-lg text-white bg-black w-auto
            ...
            transition={{delay:1, duration:1}}>
                {Array(6).fill('').map((item, index) =>(
                    ...
                    duration-300 cursor-pointer max-sm:w-10' src={index % 2 === 0 ? 
                        assets.sample_img_1 : assets.sample_img_2
                    } alt='' key={index}
                    width={70}/>
                ))}
            </motion.div>
            ...
            >Generated images from visioncraft </motion.p>
    </motion.div>
  )
}
