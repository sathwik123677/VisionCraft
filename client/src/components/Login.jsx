  ...
  return (
    ...
    backdrop-blur-sm bg-black/30 flex justify-center items-center'>
        ...
        text-slate-500'>
          ...
          <p className='text-shadow-amber-200'>Welcome back ! Please sign in the continue</p>
          ...
          text-blue-600 cursor-pointer' onClick={() => setState('Sign Up')}>Sign up</span></p> :
          
          <p className='mt-5 text-center '>Already have an account? <span className='
          text-blue-600 cursor-pointer' onClick={() => setState('Login')}>Login</span></p>
          }
